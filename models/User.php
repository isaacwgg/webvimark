...
//                        ['fullnames', 'required'],
	...
	public function attributeLabels()
	{
		return [
			...
			'email'              => UserManagementModule::t('back', 'E-mail'),
                        'fullnames'          => UserManagementModule::t('back', 'Fullnames'),
                        'phone'              => UserManagementModule::t('back', 'Phone No/Mobile No'),
                        //'profilepic'         => UserManagementModule::t('back', 'Profile Picture'),
                        'passexpirydate'     => UserManagementModule::t('back', 'passexpirydate'),
                        'boarddesc'          => UserManagementModule::t('back', 'Member Description/Brief Background'),
                        'boardposition'      => UserManagementModule::t('back', 'Member Position'),
		];
	}
        ...
        public function beforeDelete()
	{
        ...
        public function Lock($id){
	     ...
	     $newuser = $model->find()->where(['username'=>$id])->one();
             $newuser->locked=1;
             if($newuser->UPDATE(false)){
             return 1;
             }
             else{
             return 2;
